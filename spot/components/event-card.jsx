...
import QRScannerModal from "@/app/(main)/my-events/[eventId]/_components/qr-scanner-modal";
...
export default function EventCard({
  ...
  return (
    <Card
      className={`overflow-hidden group pt-0 ${onClick
      ...
      <CardContent className="space-y-3">
        ...
        {action && (
          ...
          <div className="flex gap-2 pt-2">
            ...
            {/* Check-in QR button only for organizer events */}
            {action === "event" && (
